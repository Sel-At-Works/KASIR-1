   ...
   <aside>
       <div id="sidebar" class="nav-collapse ">
           ...
           <ul class="sidebar-menu" id="nav-accordion">
               ...
               <a href="index.php?page=user" style="text-decoration: none; color: inherit;">
                   <p class="centered">
                       <img src="assets/img/user/<?php echo $hasil_profil['gambar']; ?>" class="img-circle" width="100" height="110">
                   </p>
               ...
               <li class="sub-menu">
                   ...
                   <ul class="sub">
                       <li><a href="index.php?page=produk">Produk/Keranjang</a></li>
